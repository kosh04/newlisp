...
public class FilledEllipseShape extends Shape {


int radiusX;
int radiusY;

public FilledEllipseShape(StringTokenizer tokens)
	{
...
public void drawShape(Graphics2D g2)
	...
	g2.fillOval(X - radiusX, Y - radiusY, 2 * radiusX - 1, 2 * radiusY - 1);
	}
