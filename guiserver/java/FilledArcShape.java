...
public class FilledArcShape extends Shape {
...
public FilledArcShape(StringTokenizer tokens)
	{
	...
	startAngle = Integer.parseInt(tokens.nextToken());
	arcAngle = Integer.parseInt(tokens.nextToken());
...
public void drawShape(Graphics2D g2)
	...
	g2.fillArc(X, Y, width - 1, height - 1, startAngle, arcAngle);
	}
