...
//  guiserver
//
//  Created by Lutz Mueller on 5/20/07.
//
//
...
public class ToggleButtonWidget extends aButton{

@SuppressWarnings("unchecked") 
public ToggleButtonWidget(StringTokenizer params)
	{
	abutton = new JToggleButton();
	jcomponent = abutton;
	component = abutton;
	container = abutton;
