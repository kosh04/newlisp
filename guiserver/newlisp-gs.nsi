...
; The file to write
OutFile "c:\WinDev\newlisp\newlisp-10703-win-gs-166.exe"

; The default installation directory
InstallDir $PROGRAMFILES\newlisp

; The text to prompt the user to enter a directory
DirText "This will install newLISP v.10.7.3 and Guiserver 1.66 on your computer. IF NOT INSTALLING IN THE DEFAULT DIRECTORY REBOOT AFTER INSTALL."
...
Section "newLISP program (required) and DLL"
  ...
  ; since 10.3.5 newlisp.dll is back in the newlisp directory
  ...
  CreateShortCut "$SMPROGRAMS\newLISP\Release Notes.lnk" "$INSTDIR\newLISP-10.7.3-Release.html" "" "$INSTDIR\newLISP-10.7.3-Release.html" 0
