...
; The file to write
OutFile "c:\WinDev\newlisp\newlisp-10400-win-gs-145.exe"

; The default installation directory
InstallDir $PROGRAMFILES\newlisp

; The text to prompt the user to enter a directory
DirText "This will install the newLISP-GS 1.45 and newLISP 10.4.0 on your computer. IF NOT INSTALLING IN THE DEFAULT DIRECTORY REBOOT."
...
Section "newLISP program (required) and DLL"
  ...
  CreateShortCut "$SMPROGRAMS\newLISP\Release Notes.lnk" "$INSTDIR\newLISP-10.4.0-Release.html" "" "$INSTDIR\newLISP-10.4.0-Release.html" 0
