...
; The file to write
OutFile "c:\WinDev\newlisp\newlisp-10304-win-gs-144.exe"

; The default installation directory
InstallDir $PROGRAMFILES\newlisp

; The text to prompt the user to enter a directory
DirText "This will install the newLISP-GS 1.44 and newLISP 10.3.4 on your computer. IF NOT INSTALLING IN THE DEFAULT DIRECTORY REBOOT."
...
Section "newLISP program (required) and DLL"
  ...
  ; since 10.3.3 newlisp.dll goes to windows/system32/
  ; for easy import without specifying the path
  SetOutPath $SYSDIR
  File "c:\newlisp\newlisp.dll"  
  ...
  CreateShortCut "$SMPROGRAMS\newLISP\Release Notes.lnk" "$INSTDIR\newLISP-10.3.4-Release.html" "" "$INSTDIR\newLISP-10.3.4-Release.html" 0
...
Section "Uninstall"
  ...
  Delete $INSTDIR\modules\macro.lsp
