...
; The file to write
OutFile "c:\WinDev\newlisp\newlisp-10508-win-gs-162.exe"

; The default installation directory
InstallDir $PROGRAMFILES\newlisp

; The text to prompt the user to enter a directory
DirText "This will install newLISP v.10.5.8 and Guiserver 1.62 on your computer. IF NOT INSTALLING IN THE DEFAULT DIRECTORY REBOOT AFTER INSTALL."
...
Section "newLISP program (required) and DLL"
  ...
  CreateShortCut "$SMPROGRAMS\newLISP\Release Notes.lnk" "$INSTDIR\newLISP-10.5.8-Release.html" "" "$INSTDIR\newLISP-10.5.8-Release.html" 0
