...
; The file to write
OutFile "c:\WinDev\newlisp\newlisp-10604-win-gs-164.exe"

; The default installation directory
InstallDir $PROGRAMFILES\newlisp

; The text to prompt the user to enter a directory
DirText "This will install newLISP v.10.6.4 and Guiserver 1.64 on your computer. IF NOT INSTALLING IN THE DEFAULT DIRECTORY REBOOT AFTER INSTALL."
...
Section "newLISP program (required) and DLL"
  ...
  CreateShortCut "$SMPROGRAMS\newLISP\Release Notes.lnk" "$INSTDIR\newLISP-10.6.4-Release.html" "" "$INSTDIR\newLISP-10.6.4-Release.html" 0
