...
; The file to write
OutFile "c:\WinDev\newlisp\newlisp-10600-win-gs-163.exe"

; The default installation directory
InstallDir $PROGRAMFILES\newlisp

; The text to prompt the user to enter a directory
DirText "This will install newLISP v.10.6.0 and Guiserver 1.63 on your computer. IF NOT INSTALLING IN THE DEFAULT DIRECTORY REBOOT AFTER INSTALL."
...
Section "newLISP program (required) and DLL"
  ...
  CreateShortCut "$SMPROGRAMS\newLISP\Release Notes.lnk" "$INSTDIR\newLISP-10.6.0-Release.html" "" "$INSTDIR\newLISP-10.6.0-Release.html" 0
